...
const Navbar = () => {
    ...
    return (
        ...
        <nav
        id="animated-navbar"
        className="mobile-only:bg-white flex-no-wrap fixed top-0 z-10 flex w-full items-center justify-between py-2 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4">
        <div className="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <a
                class="mb-4 me-5 ms-2 mt-3 flex items-center text-neutral-500 transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-900 dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:mb-0 lg:mt-1 lg:px-2"
            ...
            <ul
                ...
                <ul
                    ...
                    <li>
                    <a
                    class="block w-full whitespace-nowrap bg-white px-4 py-2 text-sm font-normal pointer-events-none text-black/30 dark:bg-surface-dark dark:text-white/30"
                    >Football score predictor</a>
                </li>
                    <li>
                    <a
                        class="block w-full whitespace-nowrap bg-white px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-zinc-200/60 focus:bg-zinc-200/60 focus:outline-none active:bg-zinc-200/60 active:no-underline dark:bg-surface-dark dark:text-white dark:hover:bg-neutral-800/25 dark:focus:bg-neutral-800/25 dark:active:bg-neutral-800/25"
                        href="https://asjscott.github.io/pomodoro"
                        data-twe-dropdown-item-ref
                        >React projects</a>
                    </li>
                    <li>
                ...
                <a
                    className="flex items-center text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                    href="https://asjscott.github.io/calculator"
                    data-twe-nav-link-ref
                    >Calculator</a >
                </li>
                ...
                <a
                    className="flex items-center text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                    href="https://asjscott.github.io/drum_machine"
                    data-twe-nav-link-ref
                    >Drum Machine</a >
                </li>
            </ul>
